...
# ایجاد فایل setup_viral_system.sh
cat > setup_viral_system.sh << 'EOS'
#!/bin/bash
...
# اعطای مجوز اجرا
chmod +x setup_viral_system.sh

# اجرای اسکریپت
echo -e "\033[0;32m✅ اسکریپت تنظیم سیستم با موفقیت ایجاد شد!\033[0m"
echo "برای اجرای سیستم از دستور زیر استفاده کنید:"
echo "./setup_viral_system.sh"
